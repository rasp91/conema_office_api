...
class InternalInfoItem(Base):
    __tablename__ = "kiosk_internal_info_items"
    ...
    documents = relationship(
        "InternalInfoDocument",
        back_populates="info_item",
        cascade="all, delete-orphan",
        order_by="InternalInfoDocument.sort_order",
    )
